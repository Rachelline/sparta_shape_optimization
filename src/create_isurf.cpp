        ...
        for (int jy = iyfirst; jy <= iyfirst+1; jy++) {
          for (int jx = ixfirst; jx <= ixfirst+1; jx++) {
            ...
            if (jcell < nglocal) {
              ...
              jside = svalues[jcell][n1];
              if (jside == 0 || jside == 1) {
                if (ivalues[jcell][jcorner][na1] <= 0)
                  svalues[icell][i] = jside;
                else
                  svalues[icell][i] = !jside;
                continue;
              }
